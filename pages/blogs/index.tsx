...
const postData = [
  {
    ...
    slug: { current: "lorem-ipsum" },
    mainImage: {
      src: "https://source.unsplash.com/random/800x600", // Replace with your real image URL
      alt: "Thumbnail",
    },
    author: {
      image: {
        src: "https://source.unsplash.com/random/100x100", // Replace with your real image URL
      },
      name: "John Doe",
