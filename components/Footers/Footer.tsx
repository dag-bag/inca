  ...
  return (
    <>
      ...
      <footer aria-label="site footer" className=" mt-10">
        ...
        <div className="grid md:grid-cols-5 px-5  mx-auto max-w-screen-xl">

          <div className="col-span-2 sm:col-span-1 mt-8">
            <p className="font-semibold  uppercase text-primary tracking-wide">Services</p>
          ...
          <div className="col-span-2 sm:col-span-1 mt-8">
            <p className="font-semibold  uppercase text-primary tracking-wide">Company</p>
          ...
          <div className="col-span-2 sm:col-span-1 mt-8">
            <p className="font-semibold  uppercase text-primary tracking-wide">Helpful Links</p>
            <nav aria-label="Footer Navigation - Company" className="mt-6">
              <ul className="space-y-4 text-sm">
                <li>
                  <a
          ...
          <div className="col-span-2 sm:col-span-1 mt-8">
            <p className="font-semibold  uppercase text-primary tracking-wide">Legal</p>
          ...
          <div className="col-span-2 sm:col-span-1 mt-8">
            <p className="font-semibold  uppercase text-primary tracking-wide">Downloads</p>
            <nav
          ...
          <ul className="col-span-2 flex justify-start gap-6 lg:col-span-5 lg:justify-end mt-5">
            <li>
              <a
                href="https://www.facebook.com/incancestry.alpaca?mibextid=ZbWKwL"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:opacity-75"
              >
            ...
            <li>
              <a
                href="https://instagram.com/incancestry.alpaca?igshid=NTE5MzUyOTU="
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:opacity-75"
              >
            ...
            <li>
              <a
                href="https://twitter.com/incancestry?t=ZmH8K-rMeUMb2D22x_z46Q&s=09"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:opacity-75"
              >
