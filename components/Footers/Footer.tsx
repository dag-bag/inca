...
import { PersonalDetails } from "../../data/personalInfo";
              ...
              <ul className="space-y-4 text-sm">
                ...
                <li>
                  <a
                    ...
                    className="text-gray-700 transition hover:opacity-75"
                  >
                    Get in touch with us at: <br /> {PersonalDetails.email}
                  </a>
                </li>
              </ul>
            </nav>
          ...
          <div className="col-span-2 sm:col-span-1 mt-8">
            ...
            <nav aria-label="Footer Navigation - Legal" className="mt-6">
              <ul className="space-y-4 text-sm">
                <li>
                  <a
                    href={`https://wa.me/${PersonalDetails.number.value}`}
                    className="text-gray-700 transition hover:opacity-75"
                  >
                    Whatsapp : {PersonalDetails.number.label}
                  </a>
                </li>
                <li>
                  <a
                    href="mailto:info@incancetry.com"
                    className="text-gray-700 transition hover:opacity-75"
                  >
                    Email : info@incancetry.com
                  </a>
                </li>
              </ul>
            </nav>
            ...
            <div className="sm:flex sm:justify-between">
              ...
              >
                <ul className="flex flex-wrap justify-start gap-4 text-xs lg:justify-end">
                  ...
                  <li>
                    <a
                      href="legal/returns-and-exchange"
                      className="text-gray-500 transition hover:opacity-75"
                    >
                      Returns &amp; Exchange
                    </a>
